...
int main() {
    try {
        ...
        KernelAndBackend kernels[] = {
            ...
            KernelAndBackend{ llmetal::LinearKernel(context, 32, 32), "tg32_tpr32_rpt1" },
            ...
            KernelAndBackend{ llmetal::LinearKernel(context, 64, 32), "tg64_tpr32_rpt1" },
            ...
            KernelAndBackend{ llmetal::LinearKernel(context, 128, 32), "tg128_tpr32_rpt1" },
            ...
            KernelAndBackend{ llmetal::LinearKernel(context, 256, 32), "tg256_tpr32_rpt1" },
            ...
            KernelAndBackend{ llmetal::LinearKernel(context, 512, 32), "tg512_tpr32_rpt1" },
            ...
            KernelAndBackend{ llmetal::LinearKernel(context, 1024, 32), "tg1024_tpr32_rpt1" },
