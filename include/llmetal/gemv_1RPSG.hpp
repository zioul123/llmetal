...
// One row per SIMD group.
class Gemv1RPSGKernel {
public:
    Gemv1RPSGKernel(MetalContext& context);
    ~Gemv1RPSGKernel();
    Gemv1RPSGKernel(const Gemv1RPSGKernel&) = delete;
    Gemv1RPSGKernel& operator=(const Gemv1RPSGKernel&) = delete;
    Gemv1RPSGKernel(Gemv1RPSGKernel&&) noexcept;
    Gemv1RPSGKernel& operator=(Gemv1RPSGKernel&&) noexcept;
